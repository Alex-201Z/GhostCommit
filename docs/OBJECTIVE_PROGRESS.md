...
Implement the next Phase 3 subphase: persist an explicit local project authorization mapping for created projects without starting watchers, session sync, reports, export or sharing.
