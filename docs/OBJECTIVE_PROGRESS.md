...
Implement the next Phase 3 agent-control subphase: expose user-controlled disconnect/credential clearing locally and ensure logout/revocation paths stop heartbeat credentials without starting collection, then continue without starting Phase 4.
